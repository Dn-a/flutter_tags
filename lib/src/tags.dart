...
class _TagsState extends State<Tags> {
    ...
    List<Widget> _buildItems() {
        ...
        Widget textField = widget.textField!=null ? Container(
        ...
        final List<Widget> itemList = List.generate(widget.itemCount,
                (i){
...
class DataListInherited extends InheritedWidget {
    ...
    DataListInherited({Key key,this.list,this.symmetry,this.intemCount, Widget child}): super(key:key, child: child);
...
{
    DataList({@required this.title,bool highlights=false, bool active, this.customData}): _showDuplicate = highlights, _active = active, super(active);
