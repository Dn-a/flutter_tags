...
class CustomRenderWrap extends RenderBox with ContainerRenderObjectMixin<RenderBox, WrapParentData>,
    ...
    void performLayout() {
        ...
        while (child != null) {
            ...
            if ((childCount > 0 && runMainAxisExtent + spacing + childMainAxisExtent > mainAxisLimit) || (_column!=null && _column!=0 && cnt==_column)) {
                cnt=0;
